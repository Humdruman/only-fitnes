...
class Vue
{
     ...
     * @throws Exception
     */
    public static function includeComponent($componentName, array $addFiles = []): void
    {
        if (self::$init !== true) {
            self::checkBitrix();
            self::$init = true;
            ...
            \AddEventHandler('main', 'OnEndBufferContent', [self::class, 'insertComponents']);
        }
     ...
     * @param $content
     */
    public static function insertComponents(&$content): void
    {
     ...
     * @throws Exception
     */
    protected static function checkBitrix(): void
    {
